...
public class FoodMenuListFragment extends ListFragment {
    ...
    public void onListItemClick (ListView listView, View view, int position, long id) {
        ...
        String food_menu_name = item.getFood_Name();
        ...
        protected void onPostExecute(String results) {
            ...
            try {
                ...
                while(index < jsonArray.length()) {
                    ...
                    adapter.addItem(foodMenuListViewItem.getFood_Image(), foodMenuListViewItem.getFood_Name(), foodMenuListViewItem.getFood_Description());
                    index++;
                }
            } catch (Exception e) {
                e.printStackTrace();
