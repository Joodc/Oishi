...
public class FoodMenuAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //아이템 내 각 위젯에 데이터 반영
        food_menu_image.setImageResource(context.getResources().getIdentifier(foodMenuListViewItem.getFood_Image(), "drawable", context.getPackageName()));
        food_menu_name.setText(foodMenuListViewItem.getFood_Name());
        food_menu_description.setText(foodMenuListViewItem.getFood_Description());
    ...
    public void addItem(String image, String name, String description) {
        ...
        item.setFood_Description(description);
